...
export default function MLSystem() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (data.data_preview) {
        try {
          ...
          const isValidPreview = 
            data.data_preview && 
            Array.isArray(data.data_preview.data) && 
            Array.isArray(data.data_preview.columns);
      ...
      setResult({ 
        error: error.message || "An error occurred during processing. The model might still be training in the background."
      });
    } finally {
      setIsLoading(false);
    }
  ...
  const styles = {
    ...
    title: "text-5xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-purple-600 drop-shadow-[0_2px_5px_rgba(147,51,234,0.5)]",
    ...
    uploadIcon: "mx-auto h-8 w-8 text-purple-300 mb-2 group-hover:text-purple-400 transition-colors group-hover:scale-110 duration-300",
    ...
    taskTypeButton: {
      active: "bg-gradient-to-r from-purple-600 to-purple-600 text-white border-none shadow-[0_0_15px_rgba(147,51,234,0.3)]",
    ...
    dashboardCard: "bg-black/60 border border-purple-500/30 backdrop-blur-md shadow-[0_10px_50px_-12px_rgba(147,51,234,0.25)] rounded-3xl overflow-hidden transition-all duration-500 hover:shadow-[0_20px_80px_-12px_rgba(147,51,234,0.35)] hover:border-purple-500/50",
    ...
    progressFill: "h-full bg-gradient-to-r from-purple-500 to-purple-600 rounded-full transition-all duration-500 shadow-[0_0_10px_rgba(147,51,234,0.5)]",
    ...
    emptyStateIcon: "p-6 rounded-full bg-gradient-to-br from-purple-500/20 to-purple-600/20 shadow-[0_0_30px_rgba(147,51,234,0.3)]",
    ...
    dataPreviewContainer: "bg-black/60 rounded-lg border border-purple-500/30 overflow-hidden shadow-xl backdrop-blur-sm transition-all duration-300 hover:shadow-[0_15px_30px_-5px_rgba(147,51,234,0.25)] hover:border-purple-500/50",
    dataPreviewHeader:
    ...
    datasetInfoContainer: "bg-black/60 rounded-lg border border-purple-500/30 overflow-hidden shadow-xl backdrop-blur-sm transition-all duration-300 hover:shadow-[0_15px_30px_-5px_rgba(147,51,234,0.25)] hover:border-purple-500/50",
    datasetInfoHeader:
      "flex items-center justify-between px-4 py-3 border-b border-purple-500/50 bg-gradient-to-b from-purple-900/40 to-purple-800/20",
    ...
    modelInfoContainer: "bg-black/60 rounded-lg border border-purple-500/30 overflow-hidden shadow-xl backdrop-blur-sm transition-all duration-300 hover:shadow-[0_15px_30px_-5px_rgba(147,51,234,0.25)] hover:border-purple-500/50",
    modelInfoHeader:
      "flex items-center justify-between px-4 py-3 border-b border-purple-500/50 bg-gradient-to-b from-purple-900/40 to-purple-800/20",
    ...
    modelInfoCard: "bg-black/60 rounded-lg p-4 border border-purple-500/30 backdrop-blur-sm shadow-md hover:shadow-[0_10px_20px_-5px_rgba(147,51,234,0.2)] transition-all duration-300 hover:border-purple-500/50",
    ...
    visualizationsContainer: "bg-black/60 rounded-lg border border-purple-500/30 overflow-hidden shadow-xl backdrop-blur-sm transition-all duration-300 hover:shadow-[0_15px_30px_-5px_rgba(147,51,234,0.25)] hover:border-purple-500/50",
    ...
    plotContainer: "bg-black/60 rounded-lg border border-purple-500/30 overflow-hidden backdrop-blur-sm shadow-lg hover:shadow-[0_10px_20px_-5px_rgba(147,51,234,0.2)] transition-all duration-300 hover:border-purple-500/50",
    ...
    plotContent: "p-2",
    explanationTrigger: "py-2 px-3 text-xs font-medium text-purple-400 hover:text-purple-300 hover:no-underline transition-colors duration-200",
    explanationContent: "px-3 pb-3 pt-0",
    explanationText: "text-xs text-purple-200 bg-black/60 p-2.5 rounded-md border border-purple-500/30 shadow-inner backdrop-blur-sm",
    footer: "mt-12 text-center text-purple-400 text-sm font-light tracking-wider opacity-80 hover:opacity-100 transition-opacity duration-300",
    taskTypeChangedAlert: "mb-4 border-amber-500/50 bg-amber-900/20 text-amber-300",
    autoDetectionBadge: "bg-amber-500/20 text-amber-400 border-amber-500/50 shadow-[0_0_10px_rgba(245,158,11,0.3)] text-xs",
  }
          ...
          >
              ...
              <CardContent className="space-y-6">
                {taskTypeChanged && (
                  <Alert className={styles.taskTypeChangedAlert}>
                    ...
                    <AlertDescription>
                      ...
                      <span className="font-semibold">{detectedTaskType.replace("_", " ")}</span> tasks.
                      The task type has been changed accordingly.
                    </AlertDescription>
                  </Alert>
                )}
                ...
                <div>
                  ...
                  <p className="mt-2 text-xs text-purple-300">
                    ...
                    <span className="ml-2">Task type (classification/regression/NLP) will be automatically detected from CSV data</span>
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    ...
                    <Button
                      ...
                      className={`justify-start ${
                        taskType === "image_classification" ? styles.taskTypeButton.active : styles.taskTypeButton.inactive
                  ...
                  <p className="mt-2 text-xs text-purple-300">
                    <span className="text-amber-400">Note:</span> For CSV data, the system will automatically detect if it's Classification, Regression, or NLP.
                  </p>
                </div>
              </CardContent>
            ...
            >
              ...
              <Card className={styles.dashboardCard}>
                <CardHeader className={styles.dashboardHeader} style={{ marginTop: 0, paddingTop: "1rem", paddingBottom: "1rem" }}>
                              ...
                              <div className="overflow-hidden border border-purple-500/50 rounded-lg shadow-inner">
                                <table className={styles.table}>
                                  <thead className={styles.tableHeader}>
                                    <tr>
                                      {dataPreview.columns.slice(0, 5).map((col, i) => (
                                  ...
                                  <tbody className={styles.tableBody}>
                                    {dataPreview.data.slice(0, 5).map((row, i) => (
                          ...
                          <div className={styles.modelInfoGrid}>
                            ...
                            <div className={styles.modelInfoCard}>
                              ...
                              <div className="flex items-center gap-2">
                                <div className="p-2 rounded-md bg-black/70 shadow-[0_0_10px_rgba(147,51,234,0.2)]">{taskTypeIcons[taskType]}</div>
                                <div>
                              ...
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p className="text-xs max-w-xs">
                                    These visualizations help you understand your model's performance and data
                                    patterns, generated from your actual data.
                                  </p>
                                </TooltipContent>
                              </Tooltip>
                            </TooltipProvider>
